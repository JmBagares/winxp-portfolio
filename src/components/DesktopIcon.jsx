...
export default function DesktopIcon({ icon: Icon, iconElement, iconSrc, label, onDoubleClick, onContextMenu, isSelected, onClick }) {
  ...
  return (
    ...
    >
      <div className="mb-[2px] flex h-12 w-12 items-center justify-center rounded-sm group-focus-visible:outline group-focus-visible:outline-1 group-focus-visible:outline-[#f3f9ff] group-focus-visible:outline-offset-1">
        {iconSrc
